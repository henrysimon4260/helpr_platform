...
export const styles = StyleSheet.create({
  ...
  wallMountingAnalysisOverlayBackground: {
    flex: 1,
    backgroundColor: 'rgba(0, 0, 0, 0.6)',
    justifyContent: 'center',
    alignItems: 'center',
  },
  wallMountingAnalysisModal: {
    width: '85%',
    backgroundColor: '#FFF8E8',
    borderRadius: 30,
    paddingTop: 20,
  ...
  wallMountingAnalysisRadioGroup: {
    width: '100%',
    marginBottom: 20,
  },
  wallMountingAnalysisRadioOption: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingVertical: 8,
  },
  wallMountingAnalysisRadioButton: {
    width: 20,
    height: 20,
    borderRadius: 10,
    borderWidth: 2,
  ...
  wallMountingAnalysisRadioSelected: {
    backgroundColor: '#0c4309',
  },
  wallMountingAnalysisRadioText: {
    fontSize: 16,
    color: '#0c4309',
    fontWeight: '500',
  },
  wallMountingAnalysisButtonsRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    width: '100%',
    gap: 12,
  },
  wallMountingAnalysisButton: {
    flex: 1,
    backgroundColor: '#0c4309',
    borderRadius: 25,
    paddingVertical: 12,
  ...
  wallMountingAnalysisButtonText: {
    color: '#FFFFFF',
    fontSize: 16,
    fontWeight: '600',
    textAlign: 'center',
  },
  wallMountingAnalysisCancelButton: {
    flex: 1,
    backgroundColor: '#E5DCC9',
    borderRadius: 25,
    paddingVertical: 12,
  ...
  wallMountingAnalysisCancelButtonText: {
    color: '#0c4309',
    fontSize: 16,
    fontWeight: '600',
    textAlign: 'center',
  },
  wallMountingAnalysisOptionsContainer: {
    width: '100%',
    marginBottom: 20,
  },
  wallMountingAnalysisOption: {
    backgroundColor: '#E5DCC9',
    borderRadius: 10,
    paddingVertical: 15,
    paddingHorizontal: 20,
  ...
  wallMountingAnalysisOptionSelected: {
    backgroundColor: '#0c4309',
    borderColor: '#0c4309',
  },
  wallMountingAnalysisOptionText: {
    fontSize: 16,
    color: '#0c4309',
    fontWeight: '500',
    textAlign: 'center',
  },
  wallMountingAnalysisOptionTextSelected: {
    color: '#FFFFFF',
  },
