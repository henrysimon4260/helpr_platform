...
export default function BookedServices() {
            ...
            {fillRequestCount > 0 && !isAssigned ? (
              <Pressable
                ...
                onPress={(event) => {
                  ...
                  router.push({
                    pathname: '/(booking-flow)/select-helpr' as any,
          ...
          {isAssigned ? (
            <View style={styles.confirmedButtonColumn}>
              ...
              <Pressable
                ...
                onPress={() => router.push({
                  pathname: '/(booking-flow)/service-details' as any,
                  params: { serviceId: service.service_id }
                })}
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Back Button */}
      <Pressable style={styles.backButton} onPress={() => router.push('/(home)/landing' as any)}>
        <Image 
          ...
          <View style={styles.selectProModal}>
            ...
            <Pressable 
              ...
              onPress={() => {
                ...
                router.push('/(booking-flow)/select-helpr' as any);
              }}
            >
